<template>
  <div>
    ...
    <div class="div-1">
      <el-row>
        <el-col>
          <el-button class="button-1" type="primary" @click="dialogFormVisible = true">添加</el-button>
        </el-col>
      </el-row>
      <el-row class="row-2">
        <el-col>
    ...
    <el-dialog title="添加" width="30%" :visible.sync="dialogFormVisible" :before-close="handleClose">
    ...
    <el-form :model="form" :rules="rules" ref="form">
      ...
      <el-form-item label="JIRA用户" :label-width="formLabelWidth" prop="jiraname">
        <el-input v-model="form.jiraname" autocomplete="off" class="el-input-width"></el-input>
      </el-form-item>
      <el-form-item label="email" :label-width="formLabelWidth" prop="sysname">
        <el-input v-model="form.sysname" autocomplete="off" class="el-input-width"></el-input>
      </el-form-item>
